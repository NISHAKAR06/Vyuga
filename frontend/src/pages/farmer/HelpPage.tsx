    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 text-xs">
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 shadow-sm">
          ...
          <h4 className="font-bold text-slate-900 dark:text-white text-xs">{t.helpKCC}</h4>
          <p className="text-slate-500 text-[11px] mt-0.5">{t.helpKCCSub}</p>
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 shadow-sm">
          ...
          <h4 className="font-bold text-slate-900 dark:text-white text-xs">{t.helpMandiDesk}</h4>
          <p className="text-slate-500 text-[11px] mt-0.5">{t.helpMandiDeskSub}</p>
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 shadow-sm">
          ...
          <h4 className="font-bold text-slate-900 dark:text-white text-xs">{t.helpDbtSupport}</h4>
          <p className="text-slate-500 text-[11px] mt-0.5">{t.helpDbtSupportSub}</p>
